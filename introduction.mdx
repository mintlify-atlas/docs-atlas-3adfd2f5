...
description: "Terbin is a C# framework for mod management services using named-pipe IPC, binary packet serialization, and a reflection-based command dispatcher."
---
